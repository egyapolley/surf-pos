...
import classes from './CustomTableReport.module.css'



function CustomTableReport({data,onSort,sortColumn}) {
        ...
        <div className={classes.content}>
            <table>
                ...
                <tr>
                    ...
                    <th onClick={()=>handleSort("qty")}>QUANTITY {displaySortImage("qty")}</th>
